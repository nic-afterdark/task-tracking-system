...
import { FaEnvelopeOpen, FaLock, FaUser } from "react-icons/fa";
...
const Signup = () => {
    ...
    const handleSubmit=async (e)=>{
        ...
        try{
             const url = `https://task-tracking-system-1.onrender.com/auth/signup`;
    ...
    <div className="">
          <div className="max-w-[960px] bg-black-dark grid grid-cols-2 items-center gap-20 p-5 rounded-2xl">
            ...
            <div className="max-w-80 grid gap-5">
              ...
              <form onSubmit={handleSubmit} action="" className="space-y-6 text-black">
              ...
              <div className="text-dull-white border-t border-white-light pt-4 space-y-4 text-sm">
                <p>Already have an account? <button className="text-neon-blue font-semibold cursor-pointer"
                onClick={()=>navigateTo('/auth/login')}>Log in</button></p>
                </div>
            </div>
          </div>
          <ToastContainer/>
